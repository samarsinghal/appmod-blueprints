...
output "ack_dev_controller_role_arn" {
  description = "Controller role of the ACK EKS DEV ServiceAccount for IRSA"
  value       = module.ack_dev_controller_role_arn.iam_role_arn
}

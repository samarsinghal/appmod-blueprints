...
export class EmployeesClient implements IEmployeesClient {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<EmployeeLookupDto[]> {
        ...
        var res = <any>null;
        return _observableOf<EmployeeLookupDto[]>(<any[]>res);
    }
...
export class OrdersClient implements IOrdersClient {
  ...
  protected processGetAll(response: HttpResponseBase): Observable<OrdersListVm> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse ? response.body :
        (<any>response).error instanceof Blob ? (<any>response).error : undefined;
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.orders)) {
      ...
      for (let item of this.orders)
        data["ordersList"].push(item.toJSON());
    }
    //data["createEnabled"] = this.createEnabled;
    return data;
  }
